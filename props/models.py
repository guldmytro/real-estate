...
class SiteConfiguration(SingletonModel):
    ...
    translation_api_key = models.CharField(max_length=255, null=True, blank=True, verbose_name=_('API-key for translating service'),
                                           help_text='<a href="https://lingvanex.com/">lingvanex.com</a>')
